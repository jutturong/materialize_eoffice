...
<nav>
  ...
  <div class="row">
      ...
      <form class="col s12"  action="<?=base_url()?>index.php/welcome/insert_vacation"   id="fr_vacation"  method="post"  enctype="multipart/form-data"  novalidate="novalidate" >
          ...
          <div class="row">
                ...
                <div class="input-field col s9">
                      ...
                      <div class="input-field col s3">
                          ...
                          <input type="date"  id="date_write"  name="date_write"  class="datepicker"  value="2017-04-03">
       ...
       <div class="row">
            ...
            <div class="input-field col s2">
                ...
                <input  type="radio" id="prename1"  value="1"  name="prename"   checked  />
      ...
      <label for="prename3">นางสาว</label>
            ...
            <div class="input-field col s3">
                <input placeholder="ชื่อ" id="first_name"  name="first_name" type="text" class="validate"  value="จัตุรงค์"  >
                     <label for="first_name">ชื่อ</label>
             </div>
           
           
              <div class="input-field col s3">
                  <input placeholder="นามสกุล" id="last_name"  name="last_name" type="text" class="validate"  value="เจริญฤทธิ์" >
                     <label for="last_name">นามสกุล</label>
             </div>
           
           
              <div class="input-field col s3">
                  <input placeholder="ตำแหน่ง" id="position"  name="position"    type="text" class="validate"  value="นักสารสนเทศ" >
        ...
        <div class="row">
                    ...
                    <div class="input-field col s3">
                        <input placeholder="Placeholder" id="affiliation"   name="affiliation"  type="text" class="validate" value="-">
                     <label for="affiliation">สังกัดหน่วย</label>
             </div>
            
            
             <div class="input-field col s3">
                 <input placeholder="งาน" id="work"  name="work" type="text" class="validate"  value="-">
        ...
        <div class="row">
            ...
            <div class="input-field col s3">
                <input placeholder=""  id="cumulative" name="cumulative"   type="tel" class="validate"  value="6" >
            </div>
        ...
        <div class="row">
            ...
            <div class="input-field col s3">
                <input   name="rest"  value="7"  id="rest" type="tel" class="validate" >
            </div>
        ...
        <div class="row">
            ...
            <div class="input-field col s3">
                <input  id="total"  name="total" value="13"  type="tel" class="validate" >
            </div>
        ...
        <div class="row">
            ...
            <div class="input-field col s3">
                <input  id="current"  name="current"  type="tel" value="3"  class="validate" >
            </div>
        ...
        <div class="row">
            ...
            <div class="input-field col s3">
                <input  id="keep" name="keep"  type="tel" class="validate"  value="5" >
            </div>
        ...
        <div class="row">
            ...
            <div class="input-field col s3">
                <input  id="wishes" name="wishes"  id="wishes"    value="2"  type="tel" class="validate" >
            </div>
     ...
     <div class="row">
          ...
          <div class="input-field col s2">
                          <i class="material-icons prefix">today'll</i>
                          <input type="date" id="date_begin"  name="date_begin" value="2017-04-03" class="datepicker">
          ...
          <div class="input-field col s1">
             ...
             <div class="input-field col s2">
                          <i class="material-icons prefix">today'll</i>
                          <input type="date"  id="end_date"  name="end_date"  value="2017-04-05"  class="datepicker">
           ...
           <div class="row">
            ...
            <div class="input-field col s1">
                <input placeholder="บ้านเลขที่" id="้house_number" name="house_number"  value="584/7"  type="tel" class="validate" >
            </div>
                   ...
                   <div class="input-field col s2">
                       ...
                       <input placeholder="ถนน" id="road"  name="road" type="text" class="validate"  value="มิตรภาพ"  >
                 ...
                 <div class="input-field col s2">
                     <input placeholder="ตำบล" id="district" name="district" type="text" class="validate"  value="บ้านเป็ด" >
                           <label for="district">ตำบล/แขวง</label>
                  </div>
               
                     <div class="input-field col s2">
                         <input placeholder="อำเภอ/เขต" id="city" name="city"  type="text" class="validate"  value="เมือง" >
          ...
          <div class="row">
                ...
                <div class="input-field col s1">
                  ...
                  <div class="input-field col s2">
                      <input placeholder="จังหวัด" id="province" name="province"  type="text" class="validate" value="ขอนแก่น" >
               ...
               <div class="input-field col s2">
                  <i class="material-icons prefix">phone</i>
                  <input placeholder="Placeholder" id="tel_address"  name="tel_address"  type="tel" class="validate"  value="0865421754" >
        ...
        <tbody>
          <tr>
            <td>
                <input placeholder="วัน" id="leave"  name="leave"  type="text" class="validate" value="5">
            </td>
            <td>
                <input placeholder="วัน" id="leave_thistime"  name="leave_thistime"  value="7"  type="text" class="validate">
            </td>
            <td>
                <input placeholder="วัน" id="date_total_leave"  value="12"  name="date_total_leave"  value="8"  type="text" class="validate">
            </td>
          </tr>
        ...
        <div class="row">
            ...
            <div class="input-field   col s3">
                 <label for="test1">ขอแสดงความนับถือ</label>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="input-field col s6">
                <input  id="sign"  name="sign" type="text" class="validate" value="จัตุรงค์ เจริญฤทธิ์">
                <label>(ลงชื่อ)</label>
            </div>
    ...
    <div class="input-field col s2">
        ...
        <input type="text" id="autocomplete-input"  id="name_sign"  name="name_sign"  class="autocomplete"  value="จัตุรงค์">
          <label for="name_sign">ชื่อ</label>
          
    </div>
    <div class="input-field col s2">
         
        <input type="text" id="autocomplete-input" class="autocomplete"  id="lastname_sign"  name="lastname_sign" value="เจริญฤทธิ์"  >
        ...
        <div class="row">
            ...
            <div class="input-field col s2">
                <input type="radio" class="filled-in"  name="allowed"  id="allowed1" checked="checked"  value="1"  />
      ...
      <label for="allowed2">ไม่เห็นควรอนุญาต</label>
        ...
        <div class="row">
            ...
            <div class="input-field col s2">
                <input placeholder="" id="name_inspector"  name="name_inspector"  value="กานดา"  type="text" class="validate">
                <label for="name_inspector">(ลงชื่อ)</label>
            </div>
            <div class="input-field col s2">
                <input placeholder=""id="lastname_inspector"   name="lastname_inspector"   value="เวลเลอร์"  type="text" class="validate">
            ...
            <div class="input-field col s2">
                <input placeholder="" id="name_commander"  name="name_commander"  value="สุชิรา"  type="text" class="validate">
                <label for="name_commander">(ลงชื่อ)</label>
            </div>
                <div class="input-field col s2">
                    <input placeholder=""   id="lastname_commander"  name="lastname_commander"   type="text" class="validate"  value="ประดับวงศ์" >
        ...
        <div class="row">
            ...
            <div class="input-field col s4">
                <input placeholder="" id="position_inspector"  name="position_inspector"  type="text" class="validate" value="หัวหน้าระดับ1">
            ...
            <div class="input-field col s4">
                <input placeholder="" id="position_commander"  name="position_commander" value="หัวหน้าระดับ2"  type="text" class="validate">
        ...
        <div class="row">
            ...
            <div class="input-field col s2">
                ...
                <input type="date"  id="date_inspector"   name="date_inspector"  value="2017-04-04"   class="datepicker">
            </div>
            ...
            <div class="input-field col s3">
                 ...
                 <div class="input-field col s2">
                <i class="material-icons prefix">today</i>
                <input type="date"  id="date_commander"  name="date_commander"  value="2017-04-04" class="datepicker">
            </div>
        ...
        <div class="row">
            <div class="input-field col s6">
             ...
             <div class="input-field col s2">
                 <input placeholder="" id="first_name2"   name="first_name2"  type="text" class="validate"  value="จัตุรงค์" >
                <label for="first_name2">(ลงชื่อ)</label>
            </div>
                <div class="input-field col s2">
                    <input placeholder="" id="last_name2"  name="last_name2"  type="text" class="validate" value="เจริญฤทธิ์">
        ...
        <div class="row">
            ...
            <div class="input-field col s4">
                <input placeholder="" id="last_position"  name="last_position"  type="text" class="validate"  value="นักสารสนเทศ">
        ...
        <div class="row">
            ...
            <div class="input-field col s7">
                 ...
                 <div class="input-field col s2">
                <i class="material-icons prefix">today</i>
                <input type="date"  id="last_date"   name="last_date"  class="datepicker"  value="2017-04-05">
            </div>
