  ...
  <div class="row">
   ...
   <!--   method="post" action="some_action" enctype="multipart/form-data" -->
     <!--  method="post" enctype="multipart/form-data"  --> 
      ...
      <!--      -->
     <form class="col s12" id="fr_sub11"  action="<?=base_url()?>index.php/welcome/inserttable21"    accept-charset="UTF-8" method="post" enctype="multipart/form-data"  >
      ...
      <div class="row">
        ...
        <div class="input-field col s6">
          ...
          <input id="registration_receive21" name="registration_receive21"  type="text"  placeholder="1.เลขทะเบียนรับ"  value="<?=$number_add?>" />
          <label for="registration_receive21">1.เลขทะเบียนรับ</label>
        ...
        <!--  <i class="material-icons prefix">phone</i> -->
         ...
         <!-- <input id="icon_telephone" type="tel" class="validate"> -->
          ...
          <input type="date"  id="date1_receive21"  name="date1_receive21"  class="datepicker" />
          ...
          <input  id="practice_receive21" name="practice_receive21"  type="text" class="validate" value="ทราบ"  />
          
          <label for="practice_receive21">7.การปฏิบัติ</label>
        </div>
          ...
          <input  id="note_receive21"  name="note_receive21"  type="text" class="validate"  value="ทราบและปฏฺิบัติตาม " >
          
          <label for="note_receive21">8.หมายเหตุ</label>
        </div>
